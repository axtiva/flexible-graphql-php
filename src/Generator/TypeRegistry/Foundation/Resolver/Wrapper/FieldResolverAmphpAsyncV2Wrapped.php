...
class FieldResolverAmphpAsyncV2Wrapped implements FieldResolverGeneratorInterface
{
    ...
    public function generate(Type $type, FieldDefinition $field): string
    {
        ...
        return "(function(\$rootValue, \$args, \$context, \$info) {
                    return \Amp\call(function() use (\$rootValue, \$args, \$context, \$info) { return $wrappedResolver;});
                })";
    }
}