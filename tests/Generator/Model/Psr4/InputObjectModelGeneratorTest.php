...
input TestInput {
    ...
    demoEnum: DemoEnum
    demoInput: DemoInput!
    dateScalarNotNull: DateTime!
    dateScalar: DateTime
    testScalarNotNull: TestScalar!
 ...
 * @property DateTimeImmutable $dateScalarNotNull 
 * @property null|DateTimeImmutable $dateScalar = null 
 * @property mixed $testScalarNotNull 
 * @property mixed $testScalar = null 
 */
