...
scalar HelloScalar
GQL
            )),__DIR__ . '/fixtures/ArgsFieldResolverModelGeneratorTest/case-1.php.txt'
            ,];
        yield [
            'NamedCurrency',
            'name',
...
scalar HelloScalar
GQL
            )),__DIR__ . '/fixtures/ArgsFieldResolverModelGeneratorTest/case-2.php.txt'
            ,];
        yield [
            'NamedCurrency',
            'name',
...
scalar HelloScalar
GQL
            )),__DIR__ . '/fixtures/ArgsFieldResolverModelGeneratorTest/case-3.php.txt'
            ,];
    }
}
